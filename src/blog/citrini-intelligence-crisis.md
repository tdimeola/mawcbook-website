...
title: "The 2028 Global Intelligence Crisis: A Different Perspective"
date: 2026-02-23
description: "A comment on Citrini Research's thought exercise on AI economic disruption — and what it misses about who the current system is actually serving."
---
...
I first discovered [this post](https://alapshah1.substack.com/p/the-global-intelligence-crisis) on the Wall Street Journal, but within a day all the major news outlets — and some I do not peruse — had picked up on it, calling it a "doomsday scenario," which it kind of is. So for those who picked up on that: bravo. But for the many that just gulped and moved on: don't do that.
...
That's the conversation worth having. If you want to be part of it, start with understanding what AI actually is and what it isn't — which is exactly what *My Adventures With Claude* is for. You can find it [here](https://www.amazon.com/dp/B0GPNJW8HL).
